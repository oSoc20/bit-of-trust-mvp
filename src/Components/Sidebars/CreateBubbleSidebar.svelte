...
<aside class="sidebar relative h-full min-h-screen p-8">
 <form class="mt-24 mb-4 w-full max-w-sm">
      <label
      ...
      <div class="text-right">
       <button class="bg-gray-300 hover:bg-gray-400 text-xs text-gray-800 font-bold py-2 px-4 rounded inline-flex items-center">
